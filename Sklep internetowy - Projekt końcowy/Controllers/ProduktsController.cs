...
namespace Sklep_internetowy___Projekt_końcowy.Controllers
{
    public class ProduktsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nazwa,Opis,Ocena")] Produkt produkt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nazwa,Opis,Ocena")] Produkt produkt)
        {
            if (id != produkt.Id)
            {
                return NotFound();
